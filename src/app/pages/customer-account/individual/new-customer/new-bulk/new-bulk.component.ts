...
changeContent(): void {
  ...
  onCheckValidation(): void{
    ...
    if (this.form.SchemeType == '' || this.form.AccountName == '' || this.form.SolId == '' ||
         this.form.SchemeCode == '' || this.form.GlSubHeadCode == '' ||
        this.form.CifId == '' || this.form.Manager == '' || this.form.Signatories == ['']  ) {
  ...
  onSubmitAccountForm(): void{
    ...
    console.log(this.form);
    this.customerAccount.OpeningAccountJoint(this.form).subscribe(
